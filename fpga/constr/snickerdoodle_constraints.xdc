...
# Location contraints
# PWM0 output - JB1.5
set_property PACKAGE_PIN    T11         [get_ports {pwm0}]
set_property IOSTANDARD     LVCMOS33    [get_ports {pwm0}]

# PWM0 input (from RF controller) - JB1.7
set_property PACKAGE_PIN    T10         [get_ports {pwm0_rf}]
set_property IOSTANDARD     LVCMOS33    [get_ports {pwm0_rf}]

# PWM1 output - JB2.5
set_property PACKAGE_PIN    N17         [get_ports {pwm1}]
set_property IOSTANDARD     LVCMOS33    [get_ports {pwm1}]

# PWM1 input (from RF controller) - JB2.7
set_property PACKAGE_PIN    P18         [get_ports {pwm1_rf}]
set_property IOSTANDARD     LVCMOS33    [get_ports {pwm1_rf}]

# Camera I2C
# SDA/SCL - JB1.11, JB1.12
set_property PACKAGE_PIN    P14         [get_ports {cam_iic_sda_io}]
set_property IOSTANDARD     LVCMOS33    [get_ports {cam_iic_sda_io}]

set_property PACKAGE_PIN    W13         [get_ports {cam_iic_scl_io}]
...
set_property IOSTANDARD     LVCMOS33    [get_ports {cam_hsync_i}]
...
set_property PACKAGE_PIN    Y14         [get_ports {cam_data_i[6]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {cam_data_i[6]}]

set_property PACKAGE_PIN    W15         [get_ports {cam_data_i[5]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {cam_data_i[5]}]

set_property PACKAGE_PIN    W14         [get_ports {cam_data_i[4]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {cam_data_i[4]}]

set_property PACKAGE_PIN    Y16         [get_ports {cam_data_i[3]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {cam_data_i[3]}]

set_property PACKAGE_PIN    U17         [get_ports {cam_data_i[2]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {cam_data_i[2]}]

set_property PACKAGE_PIN    Y17         [get_ports {cam_data_i[1]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {cam_data_i[1]}]
...
# JA1 Connector
#------------------------------------------------------------------------------
# Used only for reference - pick what oyu need and put it above :)
#
#### JA1.4 (IO_0_35)
